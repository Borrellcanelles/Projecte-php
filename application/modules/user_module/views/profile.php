  ...
  $("button").click(function(){
	...
	<body>
		...
		<script>
																...
																$.getJSON("http://127.0.0.1/codeigniterhelloworld/index.php/user_module/product/index/8", function( data )
																{ var items = [];
 ...
 $.getJSON("demo_ajax_json.js",function(result){
   $.each(result, function(i, field){
     $("div").append(field + " ");
															...
															<button type="button" onclick="getJson()">Click Me!</button>
											...
											<div class="tab-content no-border padding-24">
												<div id="home" class="tab-pane in active">
													<div class="row">
														<div class="col-xs-12 col-sm-3 center">
															<span class="profile-picture">
																<img class="editable img-responsive" alt="Alex's Avatar" id="avatar2" src="<?php echo base_url('assets/avatars/profile-pic.jpg'); ?>" />
															</span>
													...
													<div class="profile-users clearfix">
														<div class="itemdiv memberdiv">
															<div class="inline position-relative">
																<div class="user">
																	<a href="#">
																		<img src="<?php echo base_url('assets/avatars/avatar4.png'); ?>" alt="Bob Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline position-relative">
																<div class="user">
																	<a href="#">
																		<img src="<?php echo base_url('assets/avatars/avatar1.png'); ?>" alt="Rose Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline position-relative">
																<div class="user">
																	<a href="#">
																		<img src="<?php echo base_url('assets/avatars/avatar.png'); ?>" alt="Jim Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline position-relative">
																<div class="user">
																	<a href="#">
																		<img src="<?php echo base_url('assets/avatars/avatar5.png'); ?>" alt="Alex Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline position-relative">
																<div class="user">
																	<a href="#">
																		<img src="<?php echo base_url('assets/avatars/avatar2.png'); ?>" alt="Phil Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline position-relative">
																<div class="user">
																	<a href="#">
																		<img src="<?php echo base_url('assets/avatars/avatar3.png');?>" alt="Susan Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline position-relative">
																<div class="user">
																	<a href="#">
																		<img src="<?php echo base_url('assets/avatars/avatar1.png');?>" alt="Jennifer Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline position-relative">
																<div class="user">
																	<a href="#">
																		<img src="<?php echo base_url('assets/avatars/avatar3.png');?>" alt="Alexa Doe's avatar" />
																	</a>
																</div>
													...
													<ul class="ace-thumbnails">
														<li>
															<a href="#" data-rel="colorbox">
																<img alt="150x150" src="<?php echo base_url('assets/images/gallery/thumb-1.jpg');?>" />
																<div class="text">
														...
														<li>
															<a href="#" data-rel="colorbox">
																<img alt="150x150" src="<?php echo base_url('assets/images/gallery/thumb-2.jpg');?>" />
																<div class="text">
																	<div class="inner">Sample Caption on Hover</div>
																</div>
															</a>
														...
														<li>
															<a href="#" data-rel="colorbox">
																<img alt="150x150" src="<?php echo base_url('assets/images/gallery/thumb-3.jpg');?>" />
																<div class="text">
																	<div class="inner">Sample Caption on Hover</div>
																</div>
															</a>
														...
														<li>
															<a href="#" data-rel="colorbox">
																<img alt="150x150" src="<?php echo base_url('assets/images/gallery/thumb-4.jpg');?>" />
																<div class="text">
																	<div class="inner">Sample Caption on Hover</div>
																</div>
															</a>
														...
														<li>
															<a href="#" data-rel="colorbox">
																<img alt="150x150" src="<?php echo base_url('assets/images/gallery/thumb-5.jpg');?>" />
																<div class="text">
																	<div class="inner">Sample Caption on Hover</div>
																</div>
															</a>
														...
														<li>
															<a href="#" data-rel="colorbox">
																<img alt="150x150" src="<?php echo base_url('assets/images/gallery/thumb-6.jpg');?>" />
																<div class="text">
																	<div class="inner">Sample Caption on Hover</div>
																</div>
															</a>
